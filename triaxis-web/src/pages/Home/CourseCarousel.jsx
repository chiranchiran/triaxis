        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className=" w-full w-2/5 md:w-2/5 h-[500px] flex flex-col justify-center items-center p-8 md:p-12 bg-gray-50">
            ...
            <Button
              ...
              className="bg-green hover:shadow-lg w-35 transition-all bg-gray-800 text-white mp-4"
            >
              立即学习
            </Button>
          </div>
          {/* 左侧轮播图区域 */}
          <div className="rounded-lg w-2/5 w-full md:w-3/5 h-[500px] relative overflow-hidden">
            <div
              ref={carouselRef}
