    ...
    <section className="bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">课程模块</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">专业课程，助力能力提升</p>
        </div>

        {/* 左右平级布局：直接用flex，去掉多余“卡片感”样式 */}
        <div className="flex flex-col md:flex-row">
          {/* 左侧轮播图区域 */}
          <div className="rounded-lg w-full md:w-1/2 h-[500px] relative overflow-hidden">
            <div
              ref={carouselRef}
          ...
          <div className="w-full md:w-1/2 h-[500px] flex flex-col justify-center items-center p-8 md:p-12 bg-gray-50">
            <h3 className="text-2xl font-semibold text-gray-800 ">专业课程</h3>
            <Divider className="bg-gray-200" />
            <p className="text-gray-600 mb-20 leading-relaxed text-center">系统学习理论知识，掌握实践技能，提升专业素养与竞争力</p>
            <Button
              type="primary"
              size="large"
              className="hover:shadow-lg w-35 transition-all bg-gray-800 text-white mp-4"
            >
              立即学习
            </Button>
          </div>
