...
export const useGetSecondaryCategory = (params, options) => useGet(getCategorySecondary, ['resources', 'categories', params.subjectId, params.parentId], params, { ...options, enabled: !!params.subjectId && !!params.parentId })
