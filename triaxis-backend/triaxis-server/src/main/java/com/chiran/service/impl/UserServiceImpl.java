...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public Boolean updateUserProfile(Integer userId, UserUpdateDTO dto) {
        ...
        updateUser.setProfessionalFieldId(dto.getProfessionalFieldId());
    ...
    public MembershipVO getMembershipInfo(Integer userId) {
        ...
        membership.setMembershipLevel(user.getMembershipLevel());

        // 设置会员等级名称
        String[] levelNames = {"普通用户", "VIP", "SVIP"};
        membership.setMembershipLevelName(levelNames[user.getMembershipLevel()]);

        membership.setMembershipExpiresAt(user.getMembershipExpiresAt());
